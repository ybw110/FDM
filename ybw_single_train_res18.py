...
from ybw_single_model import CustomResNet18_yu,CustomResNet18_feiyu
...
results_dir = os.path.join('single_results', current_time)
...
def main():
    ...
    model = CustomResNet18_yu(num_classes=Config.num_classes, dropout_rate=Config.dropout_rate).to(device)
